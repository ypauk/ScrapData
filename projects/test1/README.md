...
python ../ai_workflow.py analyze test1

# 2. Сохрани ответ ИИ в AI_OUTPUT/analysis.md
python ../ai_workflow.py project test1

# 3. Сохрани ответ в AI_OUTPUT/project_plan.md
python ../ai_workflow.py module scraper test1
python ../ai_workflow.py module parser test1
